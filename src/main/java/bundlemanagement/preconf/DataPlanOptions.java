...
public enum DataPlanOptions {
	 ...
	 * Data Plan Options
	 */
	PLATINUM("Platinum Data Plan", "10 GB"), GOLD("Gold Data Plan", "4 GB"), SILVER("Silver Data Plan", "2 GB"),
	BRONZE("Bronze Data Plan", "1 GB"), ZERO("Zero Data Plan", "0 GB");

	/**
	 * The dataPlanOptionDescription will store the description for related data
	 * plan.
	 */
