...
public enum CallingPlanOptions {
	...
	BRONZE("Bronze Calling Plan", "30 min free Canada wide calling"), ZERO("Zero Calling Plan", "Zero min");

	/**
	 * The callingPlanOptionDescription will store the description for related
	 * calling plan.
	 */
